...
function Gruvbox()
    ...
    hi.TSStrike                     = { guifg = colors.base04, guibg = nil, gui = 'strikethrough', guisp = nil }
    ...
    -- NvimTree
    hi.NvimTreeSymlink              = { guifg = colors.base0D, guibg = nil, gui = 'bold,underline', guisp = nil }
    hi.NvimTreeSpecialFile          = { guifg = colors.base09, guibg = nil, gui = 'bold,underline', guisp = nil }
    hi.NvimTreeExecFile             = { guifg = colors.base09, guibg = nil, gui = 'bold', guisp = nil }
    hi.NvimTreeEmptyFolder          = { guifg = colors.base0D, guibg = nil, gui = 'bold', guisp = nil }
    hi.NvimTreeRootFolder           = { guifg = colors.base08, guibg = nil, gui = 'bold', guisp = nil }
    hi.NvimTreeGitNew               = { guifg = colors.base0E, guibg = nil, gui = NONE, guisp = nil }
    hi.NvimTreeGitDirty             = { guifg = colors.base08, guibg = nil, gui = NONE, guisp = nil }
    hi.NvimTreeFileDirty            = { guifg = colors.base08, guibg = nil, gui = NONE, guisp = nil }
    hi.NvimTreeFileNew              = { guifg = colors.base0E, guibg = nil, gui = NONE, guisp = nil }
    hi.NvimTreeGitStaged            = { guifg = colors.base0C, guibg = nil, gui = NONE, guisp = nil }
    hi.NvimTreeFileStaged           = { guifg = colors.base02, guibg = nil, gui = NONE, guisp = nil }
    hi.NvimTreeGitMerge             = { guifg = colors.base0A, guibg = nil, gui = NONE, guisp = nil }

    -- Fix TODO, FIXME, HACK and WARNING colors
    -- vim.api.nvim_set_hl(0, '@text.note', { link = 'Todo' })
    vim.cmd [[hi! link @text.note Todo]]
    vim.cmd [[hi! link @text.todo Todo]]
    vim.cmd [[hi! link @text.hack Debug]]
    vim.cmd [[hi! link @text.danger Debug]]
    vim.cmd [[hi! link @text.warning Title]]
    ...
    hi.CmpItemMenu                  = { guifg = colors.base04, guibg = nil, gui = NONE, guisp = nil }

    hi.NormalFloat                  = { guifg = nil, guibg = colors.base01, gui = NONE, guisp = nil }
    hi.LspInlayHints                = { guifg = colors.base04, guibg = nil, gui = NONE, guisp = nil }
