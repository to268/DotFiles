...
map("n", "<leader>gcl", ":lua require('telescope.builtin').git_commits()<CR>", opts)
map("n", "<leader>gcb", ":lua require('telescope.builtin').git_bcommits()<CR>", opts)
map("n", "<leader>gst", ":lua require('telescope.builtin').git_stash()<CR>", opts)
